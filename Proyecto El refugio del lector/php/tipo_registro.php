...
<head>
    ...
    <link rel="stylesheet" href="../css/css_tipo_registro.css">
...
<body>
  <header>
    ...
    <section>
    <form action="formulario_registro.php" method="POST" class="recordType">
        <label for="">¿Cómo deseas registrarte?</label>
        <input type="submit" value="cliente" name="registro">
        <input type="submit" value="vendedor" name="registro">
    </form>
    </section>
    <footer>
